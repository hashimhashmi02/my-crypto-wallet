  ...
  const deriveWallet = (
    ...
    try {
      if (currentPathType === "60") {
        ...
        return { publicKey: wallet.address, privateKey: wallet.privateKey, path };
    ...
    <div className="flex flex-col gap-8 p-4 max-w-4xl mx-auto">
          ...
          {!pathType ? (
            <div className="text-center my-12">
              ...
              <div className="flex gap-4 justify-center mt-4">
                ...
                <button
                  className="px-6 py-2 bg-fuchsia-600 text-white rounded-lg"
            ...
            <div className="my-12">
              ...
              <p className="text-gray-500 mt-2">
                Enter an existing phrase or leave blank to generate a new one.
              </p>
      ...
      {uiStep === 'showMnemonic' && (
        <div className="my-12 text-center">
          ...
          <button
            className="px-8 py-3 bg-teal-600 text-white rounded-lg"
            onClick={handleConfirmAndCreateWallets}
          >
